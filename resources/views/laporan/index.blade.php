                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition">
                            ...
                            <form action="{{ route('laporan.stok-harian') }}" method="GET" class="mb-4">
                                @csrf
                                <div class="mb-4">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition">
                            ...
                            <form action="{{ route('laporan.stok-bulanan') }}" method="GET" class="mb-4">
                                @csrf
                                <div class="mb-4">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition">
                            ...
                            <a href="{{ route('laporan.stok-barang') }}" class="block w-full bg-purple-500 hover:bg-purple-600 text-white font-medium py-2 px-4 rounded-md text-center transition">
                                Lihat Laporan
                            </a>
                        </div>
                    </div>
