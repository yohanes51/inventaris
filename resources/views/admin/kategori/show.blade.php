                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-2 px-4 border-b">
                                                <a href="{{ route('admin.barang.show', $barang->id) }}" class="text-blue-500 hover:text-blue-700">Detail</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                        ...
                        <div class="mt-8 flex space-x-3">
                            <a href="{{ route('admin.kategori.edit', $kategori->id) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded">Edit Kategori</a>
