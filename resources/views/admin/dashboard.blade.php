                        ...
                        <table class="min-w-full bg-white">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b text-center">
                                        <a href="{{ route('admin.stok-transaksi.create') }}?barang_id={{ $barang->id }}&tipe=masuk" class="inline-flex bg-blue-500 hover:bg-blue-700 text-white text-xs py-1 px-2 rounded">
                                            Tambah Stok
                                        </a>
                                    </td>
                                </tr>
