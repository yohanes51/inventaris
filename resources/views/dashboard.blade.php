            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="overflow-x-auto">
                        ...
                        <div class="mt-4">
                            <a href="{{ route('laporan.stok-barang') }}" class="text-blue-500 hover:text-blue-700">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <a href="{{ route('stok-transaksi.create') }}?tipe=masuk" class="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white p-6 rounded-lg text-center shadow">
                        ...
                        <a href="{{ route('barang.create') }}" class="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white p-6 rounded-lg text-center shadow">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <a href="{{ route('laporan.index') }}" class="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white p-6 rounded-lg text-center shadow">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 bg-white border-b border-gray-200">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <a href="{{ route('stok-transaksi.index') }}" class="text-blue-500 hover:text-blue-700 text-sm">
                                    Lihat Semua
                                </a>
                            </div>
                            <div class="overflow-x-auto">
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-6">
                        <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <div class="mt-4">
                                <a href="{{ route('laporan.stok-harian') }}?tanggal={{ date('Y-m-d') }}" class="text-blue-500 hover:text-blue-700">
                                    Laporan hari ini →
                                </a>
                            </div>
                        </div>
